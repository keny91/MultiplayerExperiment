...
public class PlayerShooting : NetworkBehaviour {
    ...
    private void Update()
    {
        ...
        {
           // Debug.Log("SHOOT: PHASE 4.");
            // ... launch the shell.
            m_Fired = true;
            CmdFire(m_CurrentLaunchForce);
        }

       // Debug.Log("m_Fired" + m_Fired);
    }



    /// <summary>
    /// Server order to make a player shoot. Creating a cinematic prefab.
    /// </summary>
    /// <param name="force">Parameter instanciating the initial velocity of the bullet oject.</param>
    [Command]
